...
export default {
    ...
    methods: {
        ...
        go_to_link(target_url) {
            window.open('http://'+target_url)
        }
    }
    // data() {
    //     return {
